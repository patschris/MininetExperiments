...
def apply_experiment(car,client,switch):
    ...
    # measuring latency
    car[0].cmd('ping 192.168.1.7 -c 20 > ph1_p_tmp1')
    car[3].cmd('ping 200.0.10.2 -c 20 > ph1_p_tmp2')
    os.system('awk -F \"time=\" \'{print $2}\' ph1_p_tmp1 | tail -24 | head -20 | awk \'{print $1}\' > ph1_p_c0-c3')
    os.system('awk -F \"time=\" \'{print $2}\' ph1_p_tmp2 | tail -24 | head -20 | awk \'{print $1}\' > ph1_p_c3-cl')

    #####

    # measuring jitter and packet loss
    car[3].cmd('iperf -s -u -i 1 > ph1_ip_tmp1 &')
    car[0].cmd('iperf -c 192.168.1.7 -u -i 1 -t 20')
    os.system('awk -F \"/sec \" \'{print $2}\' ph1_ip_tmp1 | tail -21 | head -20 > ph1_ip_c0-c3')

    client.cmd('iperf -s -u -i 1 > ph1_ip_tmp2 &')
    car[3].cmd('iperf -c 200.0.10.2 -u -i 1 -t 20')
    os.system('awk -F \"/sec \" \'{print $2}\' ph1_ip_tmp2 | tail -21 | head -20 > ph1_ip_c3-cl')
    ...
    car[0].cmd('iperf -c 200.0.10.2 -u -i 1 -t 20 -b')
    ...
    os.system('awk -F \"time=\" \'{print $2}\' ph3_p_tmp1 | tail -24 | head -20 | awk \'{print $1}\' > ph3_p')

    #####


    # measuring jitter and packet loss
    client.cmd('iperf -s -u -u -i 1 > ph3_ip_tmp1 &')
    car[0].cmd('iperf -c 200.0.10.2 -u -i 1 -t 20')
    os.system('awk -F \"/sec \" \'{print $2}\' ph3_ip_tmp1 | tail -21 | head -20 > ph3_ip')
